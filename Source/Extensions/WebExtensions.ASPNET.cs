...
namespace OneAll
{
	...
	public static class WebExtensionsAspnet
	{
		#region Methods
		...
		public static string OneAllSharingDisplayScript(this Page page)
		{
			return OneAllSharingDisplayScript(page, Settings.Instance.SharingButtonStyle);
		}
		...
		/// <returns>A string of HTML to cause the sharing API to be rendered.</returns>
		public static string OneAllSharingDisplayScript(this Page page, OneAllButtonStyle style, bool socialInsights)
		{
			return OneAllSharingDisplayScript(page, style, socialInsights, Settings.Instance.TitleFormat);
		}
		#endregion OneAllSharingDisplayScript
		...
		public static string OneAllDisplayLinkScript(this Page page, string token)
		{
			return OneAllDisplayScript(page, true, token, string.Empty, Settings.Instance.DisplayLogOn.Width, Settings.Instance.DisplayLogOn.Height,
		...
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLinkScript(this Page page, string token, Uri callbackUrl)
		{
			return OneAllDisplayScript(page, true, token, string.Empty, Settings.Instance.DisplayLogOn.Width, Settings.Instance.DisplayLogOn.Height,
		...
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLinkScript(this Page page, string token, params string[] providers)
		{
			return OneAllDisplayScript(page, true, token, string.Empty, Settings.Instance.DisplayLogOn.Width, Settings.Instance.DisplayLogOn.Height,
		...
		/// <param name="providers">A list of the providers to the displayed. This cannot be null or empty and cannot contain empty elements.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLinkScript(this Page page, string token, Uri callbackUrl, params string[] providers)
		{
			return OneAllDisplayScript(page, true, token, string.Empty, Settings.Instance.DisplayLogOn.Width, Settings.Instance.DisplayLogOn.Height,
		...
		/// <param name="providers">A list of the providers to the displayed. This cannot be null or empty and cannot contain empty elements.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLinkScript(this Page page, string token, int countHigh, Uri callbackUrl, params string[] providers)
		{
			return OneAllDisplayScript(page, true, token, string.Empty, Settings.Instance.DisplayLogOn.Width, countHigh,
				Settings.Instance.DisplayLogOn.Theme, callbackUrl, true, Settings.Instance.DisplayLogOn.SameWindow, providers);
		}
		#endregion OneAllDisplayLinkScript
		...
		/// <param name="providers">A list of the providers to the displayed. This cannot be null or empty and cannot contain empty elements.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLinkScript(this Page page, string token, Uri callbackUrl, int countWide, params string[] providers)
		{
			return OneAllDisplayScript(page, true, token, string.Empty, countWide, Settings.Instance.DisplayLogOn.Height,
				Settings.Instance.DisplayLogOn.Theme, callbackUrl, true, Settings.Instance.DisplayLogOn.SameWindow, providers);
		}
		#endregion OneAllDisplayLinkScript
		...
		/// <param name="providers">A list of the providers to the displayed. This cannot be null or empty and cannot contain empty elements.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLinkScript(this Page page, string token, int countWide, int countHigh, Uri callbackUrl, params string[] providers)
		{
			return OneAllDisplayScript(page, true, token, string.Empty, countWide, countHigh,
				Settings.Instance.DisplayLogOn.Theme, callbackUrl, true, Settings.Instance.DisplayLogOn.SameWindow, providers);
		}
		#endregion OneAllDisplayLinkScript
		...
		/// <param name="providers">A list of the providers to the displayed. This cannot be null or empty and cannot contain empty elements.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLinkScript(this Page page, string token, int countWide, int countHigh, string theme, Uri callbackUrl, params string[] providers)
		{
			return OneAllDisplayScript(page, true, token, string.Empty, countWide, countHigh, theme, callbackUrl, true, Settings.Instance.DisplayLogOn.SameWindow, providers);
		}
		#endregion OneAllDisplayLinkScript
		...
		/// <param name="page">The <see cref="Page" /> being executed.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLogOnScript(this Page page)
		{
			return OneAllDisplayScript(page, false, string.Empty, string.Empty, Settings.Instance.DisplayLogOn.Width, Settings.Instance.DisplayLogOn.Height,
		...
		/// <param name="callbackUrl">The URL the OneAll API calls back to with results. This cannot be null or empty.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLogOnScript(this Page page, Uri callbackUrl)
		{
			return OneAllDisplayScript(page, false, string.Empty, string.Empty, Settings.Instance.DisplayLogOn.Width, Settings.Instance.DisplayLogOn.Height,
				Settings.Instance.DisplayLogOn.Theme, callbackUrl, true, Settings.Instance.DisplayLogOn.SameWindow, Settings.Instance.ProviderNames.ToArray());
		}
		...
		/// <param name="providers">A list of the providers to the displayed. This cannot be null or empty and cannot contain empty elements.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLogOnScript(this Page page, params string[] providers)
		{
			return OneAllDisplayScript(page, false, string.Empty, string.Empty, Settings.Instance.DisplayLogOn.Width, Settings.Instance.DisplayLogOn.Height,
				Settings.Instance.DisplayLogOn.Theme, Settings.Instance.DisplayLogOn.Callback.ResolveFullUrl(), true, Settings.Instance.DisplayLogOn.SameWindow, providers);
		}
		...
		/// <param name="providers">A list of the providers to the displayed. This cannot be null or empty and cannot contain empty elements.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLogOnScript(this Page page, Uri callbackUrl, params string[] providers)
		{
			return OneAllDisplayScript(page, false, string.Empty, string.Empty, Settings.Instance.DisplayLogOn.Width, Settings.Instance.DisplayLogOn.Height,
				Settings.Instance.DisplayLogOn.Theme, callbackUrl, true, Settings.Instance.DisplayLogOn.SameWindow, providers);
		}
		...
		/// <param name="providers">A list of the providers to the displayed. This cannot be null or empty and cannot contain empty elements.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLogOnScript(this Page page, int countHigh, Uri callbackUrl, params string[] providers)
		{
			return OneAllDisplayScript(page, false, string.Empty, string.Empty, Settings.Instance.DisplayLogOn.Width, countHigh,
				Settings.Instance.DisplayLogOn.Theme, callbackUrl, true, Settings.Instance.DisplayLogOn.SameWindow, providers);
		}
		#endregion OneAllDisplayLogOnScript
		...
		/// <param name="providers">A list of the providers to the displayed. This cannot be null or empty and cannot contain empty elements.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLogOnScript(this Page page, Uri callbackUrl, int countWide, params string[] providers)
		{
			return OneAllDisplayScript(page, false, string.Empty, string.Empty, countWide, Settings.Instance.DisplayLogOn.Height,
				Settings.Instance.DisplayLogOn.Theme, callbackUrl, true, Settings.Instance.DisplayLogOn.SameWindow, providers);
		}
		#endregion OneAllDisplayLogOnScript
		...
		/// <param name="providers">A list of the providers to the displayed. This cannot be null or empty and cannot contain empty elements.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLogOnScript(this Page page, int countWide, int countHigh, Uri callbackUrl, params string[] providers)
		{
			return OneAllDisplayScript(page, false, string.Empty, string.Empty, countWide, countHigh,
				Settings.Instance.DisplayLogOn.Theme, callbackUrl, true, Settings.Instance.DisplayLogOn.SameWindow, providers);
		}
		#endregion OneAllDisplayLogOnScript
		...
		/// <param name="providers">A list of the providers to the displayed. This cannot be null or empty and cannot contain empty elements.</param>
		/// <returns>The HTML for the OneAll script intended for displaying the options.</returns>
		public static string OneAllDisplayLogOnScript(this Page page, int countWide, int countHigh, string theme, Uri callbackUrl, params string[] providers)
		{
			return OneAllDisplayScript(page, false, string.Empty, string.Empty, countWide, countHigh, theme, callbackUrl, true, Settings.Instance.DisplayLogOn.SameWindow, providers);
		}
		#endregion OneAllDisplayLogOnScript
		...
		{
			string retVal = string.Empty;
			if (page != null || page == null) { retVal = ExtensionImplementations.OneAllDisplayScript(link, token, targetId, countWide, countHigh, theme, callbackUrl, createTarget, sameWindow, providers); }
		...
		public static string OneAllHeaderScript(this Page page)
		{
			return page.OneAllHeaderScript(Settings.Instance.Domain.GetFullUrl(Settings.Instance));
		}
		...
		{
			string retVal = string.Empty;
			if (page != null || page == null) { retVal = ExtensionImplementations.OneAllHeaderScript(domain); }
		...
		/// <param name="request">The <see cref="HttpRequest"/> from the current context.</param>
		/// <example>
		...
		/// <returns>The <see cref="Guid"/> representing the OneAll token if it exists, or an <see cref="Guid.Empty"/>.</returns>
		public static Guid OneAllToken(this HttpRequest request)
		{
		...
		public static bool OneAllTokenExists(this HttpRequest request)
		{
		...
		public static Response<SnapshotResult> OneAllSharingAnalyticsSnapshot(this HttpRequest request)
		{
